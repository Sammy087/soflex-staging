  ...
  return (
    <div className="bg-[#f7f7f7] flex flex-row justify-center w-full">
      <div className="bg-ccinput-bg w-[390px] h-[844px] relative">
        ...
        <div className="w-[357px] gap-6 absolute top-[141px] left-4 flex flex-col items-start">
          <div className="gap-3 relative self-stretch w-full flex-[0_0_auto] flex flex-col items-start">
            <div className="relative w-[356.42px] mt-[-1.00px] [font-family:'Montserrat',Helvetica] font-semibold text-ccblack-00 text-xl tracking-[0] leading-[normal]">
              Lorem Ipsum is simply dummy
            </div>
            <p className="relative w-[356.42px] [font-family:'Montserrat',Helvetica] font-normal text-ccblack-00 text-sm tracking-[0] leading-[21px]">
        ...
        <div className="fixed w-[390px] h-[90px] top-0 left-0">
          ...
          <div className="absolute top-[54px] left-[120px] [font-family:'Montserrat',Helvetica] font-semibold text-ccblack-00 text-2xl tracking-[0] leading-[normal]">
            Privacy policy
          </div>
          <ArrowUp className="!absolute !w-8 !h-8 !top-[53px] !left-4" />
        </div>
      </div>
    </div>
  );
