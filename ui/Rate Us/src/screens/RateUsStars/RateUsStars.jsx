...
export const RateUsStars = () => {
  return (
    <div className="flex flex-col items-center gap-6 pt-6 pb-2 px-6 relative bg-ccwhite-ff">
      ...
      <div className="flex flex-col w-[313px] items-start gap-6 relative flex-[0_0_auto]">
        <div className="flex flex-col items-center gap-4 relative self-stretch w-full flex-[0_0_auto]">
          <p className="relative w-[293.02px] mt-[-1.00px] [font-family:'Montserrat',Helvetica] font-semibold text-main-shadesmain-color text-2xl text-center tracking-[0] leading-[normal]">
        ...
        <div className="flex flex-col w-[313px] items-center gap-4 relative flex-[0_0_auto]">
          <p className="relative w-[293.02px] mt-[-1.00px] [font-family:'Montserrat',Helvetica] font-semibold text-ccblack-00 text-lg text-center tracking-[0] leading-[normal]">
            Something is not satisfing? Tell us more, and we’ll fix it!
          </p>
          <div className="flex flex-col items-start gap-4 relative self-stretch w-full flex-[0_0_auto]">
            ...
            <div className="flex flex-col items-start gap-1 relative self-stretch w-full flex-[0_0_auto]">
              ...
              <div className="flex h-[173px] items-start gap-2.5 px-3 py-4 relative self-stretch w-full rounded-xl border border-solid border-greygrey-300">
